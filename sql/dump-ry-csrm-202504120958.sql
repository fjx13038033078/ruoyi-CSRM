...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='入学复查表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=242 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_notice` VALUES (1,'欢迎大家使用','2',_binary '<p>本科生学籍管理系统开放啦，欢迎大家积极使用</p>','0','admin','2024-02-28 22:23:43','admin','2025-04-12 09:51:30','管理员'),(2,'本科生学籍管理预约系统维护','1',_binary '<p>系统维护中，两天后正常开放</p>','0','admin','2024-02-28 22:23:43','admin','2025-04-12 09:51:47','管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=232 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','2','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','2','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'学生用户','common',4,'1',0,1,'0','0','admin','2024-02-28 22:41:32','admin','2025-04-09 10:02:47','普通用户'),(102,'老师','teacher',2,'1',1,1,'0','0','admin','2025-04-09 10:03:04','',NULL,NULL),(103,'临时用户','temporary',3,'1',1,1,'0','0','admin','2025-04-09 10:03:47','admin','2025-04-09 14:55:59',NULL);
...
INSERT INTO `sys_role_menu` VALUES (101,2031),(101,2032),(101,2033),(101,2034),(101,2042),(103,2043),(103,2044);
...
INSERT INTO `sys_user` VALUES (1,100,'admin','管理员','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2025-04-12 09:49:55','admin','2024-02-28 22:23:42','','2025-04-12 09:49:55','管理员',333.20),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-02-28 22:23:42','admin','2024-02-28 22:23:42','',NULL,'测试员',NULL),(100,100,'zhangsan','张三','00','','13089876578','0','','$2a$10$g86PdbK5Z28hgOkGfevFCuO0KekkjR6OJdAHt8gCyLJFG3Uos.3JO','0','0','127.0.0.1','2025-04-09 17:13:01','admin','2024-03-04 18:58:34','admin','2025-04-09 17:13:25',NULL,10.00),(101,100,'lisi','李四','00','','13909879876','0','','$2a$10$aiYx9RhkHXWto9AK.rMgu.MobzG6j76WtZ5jetHTmi67xJjcZ9tZq','0','0','',NULL,'admin','2024-03-04 18:58:57','admin','2025-04-09 17:00:12',NULL,10.00),(102,100,'wangwu','王五','00','','13809897654','1','','$2a$10$fvHIaJ0kOyCPYIFlo6Tnn.juTWodmgWP6IT/9D6qzI77zT6hhLNGS','0','0','127.0.0.1','2024-03-10 11:35:34','admin','2024-03-04 18:59:22','admin','2025-04-09 17:00:28',NULL,9666.80),(103,100,'zhaoliu','赵六','00','','13098987678','1','','$2a$10$W/Jh9aLcunw7wGAFa7GSuOcNroWzbk5Dy4AXPb7Ke85BIJdsEQNrC','0','0','127.0.0.1','2025-01-17 16:37:17','admin','2024-03-04 18:59:55','admin','2025-01-17 16:37:17',NULL,10000.00),(104,NULL,'wangmazi','wangmazi','00','','','0','','$2a$10$d7SEN8DpUu.Adog7C3ilkurHPEU7F8a/gvUHR0SVL8lU4h1pr3LGO','0','0','',NULL,'','2025-03-20 11:01:58','',NULL,NULL,NULL),(105,NULL,'zhouqi','zhouqi','00','','','0','','$2a$10$d0HbND9zWGM3cBQR3YKU8.3u0DZXq4seK.516l4ew8zxnMb0GJ8XS','0','0','127.0.0.1','2025-04-09 17:15:19','','2025-04-09 17:15:04','','2025-04-09 17:15:19',NULL,NULL);
...
INSERT INTO `sys_user_role` VALUES (1,1),(100,103),(101,102),(102,101),(103,101),(104,101),(105,103);
...
-- Dump completed on 2025-04-12  9:58:36
